...
const Process = () => {
  ...
  const steps = [
    ...
    { title: 'Execution', short: 'Master craftsmen.', desc: 'Premium materials meet master builders. Our site engineers ensure the blueprint is executed flawlessly.', image: 'https://images.unsplash.com/photo-1541888081600-410a562f790c?auto=format&fit=crop&q=80&w=1200' },
    { title: 'Handover', short: 'Welcome home.', desc: 'The final walkthrough. We hand over the keys to a space that is impeccably finished, clean, and ready for life.', image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?auto=format&fit=crop&q=80&w=1200' }
  ];
